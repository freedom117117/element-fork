...
exports.default = {
  ...
  methods: {
    onFieldChange: function onFieldChange(component, callback) {
      ...
      var valid = true;
      _tableBody2.default.methods.validate('change', row, column, cell, this.rules, function (errors) {
        if (errors) {
          valid = false;
        }
    ...
    tableValidate: function tableValidate(callback) {
      ...
      for (var i = 0; i < node.length; i++) {
        var _loop = function _loop(j) {
          ...
          _tableBody2.default.methods.validate('', row, column, cell, _this.rules, function (errors) {
            if (errors) {
              valid = false;
            }
  ...
  methods: {
    ...
    getHeaderCellClass: function getHeaderCellClass(rowIndex, columnIndex, row, column) {
      ...
      if (this.table.rules && column.property && this.table.rules[column.property]) {
        if (this.table.rules[column.property].some(function (item) {
